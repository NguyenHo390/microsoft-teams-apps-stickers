...
namespace StickersTemplate.Providers
{
    ...
    public class StickerSetIndexer : IStickerSetIndexer
    {
        ...
        /// <inheritdoc />
        public Task<IEnumerable<Sticker>> FindStickersByQuery(string query, int skip = 0, int count = 100, CancellationToken cancellationToken = default(CancellationToken))
        {
